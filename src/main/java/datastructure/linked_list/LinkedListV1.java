...
public class LinkedListV1 implements LinkedList {
    ...
    public Node getNthNode(int n) {
        if (this.head == null)
            throw new RuntimeException("LinkedListV1 Empty");
        else {
            Node ptr = this.head;
            int count = 1;
...
//    }
    ...
    // Method to remove duplicate from sorted linked-list
    ...
    // Method to remove duplicate from unsorted linked-list
    public void removeDuplicateFromUnsortedLL() {
        if (this.head == null || this.head.next == null)
            return;
    ...
    // Method to move last element in front of linked-list
